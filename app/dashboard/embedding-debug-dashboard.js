...
export default function EmbeddingDebugDashboard() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 bg-background">
                ...
                <div className="rounded-lg shadow p-4">
                    ...
                    <div className="space-y-2">
                        <button 
                            ...
                            className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded disabled:opacity-50 w-full"
                        >
            ...
            <div className="mt-8 rounded-lg shadow p-4">
                ...
                <div className="prose max-w-none">
                    ...
                    <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <li>Set up a Supabase Edge Function or external cron service to call <code className="px-1 rounded">/api/cron/process-embeddings</code> endpoint</li>
